    ...
    <div className="bg-[#f5f0e8] text-[#1a1610]">
      ...
      <section className="bg-[#1a1610] text-white">
        <div className="mx-auto flex max-w-[896px] flex-col gap-8 px-6 py-20 sm:flex-row sm:items-center sm:justify-between sm:px-8 sm:py-20">
          <h2 className="max-w-[390px] font-serif text-[34px] font-light leading-[1.25] sm:text-[38px]">Vil du vite mer<br />eller jobbe sammen?</h2>
          <Link to="/kontakt" className="flex items-center gap-3 text-[16px] tracking-[.4px] transition-opacity hover:opacity-70"><span className="h-px w-10 bg-white" />Ta kontakt</Link>
        </div>
      </section>
